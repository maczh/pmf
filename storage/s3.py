...
class S3Manager:
    def __init__(self, access_key: str, secret_key: str, endpoint_url: str = None, region_name: str = 'us-east-1'):
        """初始化S3连接"""
    ...
    def upload_object(self, bucket_name: str, object_key: str, file_path: str) -> bool:
        """上传对象"""
        try:
    ...
    def get_object(self, bucket_name: str, object_key: str, file_path: str) -> bool:
        """获取对象"""
        try:
    ...
    def get_object_url(self, bucket_name: str, object_key: str, expires_in: int = 3600) -> Optional[str]:
        """生成对象HTTP URL链接"""
        try:
